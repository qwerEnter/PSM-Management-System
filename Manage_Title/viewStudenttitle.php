                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <!-- SEARCH TITLE-->   
                                <form method="POST">
                                    <input type="text" class="form-control" name="keyword" placeholder="Search here..." required="required"><br>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $query = mysqli_query($bd, "SELECT * FROM title WHERE  title LIKE '%$keyword%'") or die(mysqli_error());
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $fetch['stud_matric']; ?></td>
                                                <td><?php echo $fetch['title']; ?></td>
                                                <td><?php echo $fetch['title_description']; ?></td>
                                                <td><a href="viewtitleStud.php?id=<?php echo $fetch["title_id"];?>" class="btn btn-warning">View</a></td>
                                                <td><a href="viewlogbook.php?id=<?php echo $fetch['title_id'] ?>" class="btn btn-info">Option</a></td>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $query = mysqli_query($bd, "SELECT * FROM title  ORDER BY title_id  ASC") or die(mysqli_error());
                                                while($fetch = mysqli_fetch_array($query)){
                                            ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $fetch['title_description']; ?></td>
                                                <td><a href="viewtitleStud.php?id=<?php echo $fetch["title_id"];?>" class="btn btn-warning">View</a></td>
                                                <td><a href="approvalTitle.php?id=<?php echo $fetch['title_id'] ?>" class="btn btn-info">Option</a></td>
