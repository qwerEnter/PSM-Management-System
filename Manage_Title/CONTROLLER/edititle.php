...
if(isset($_POST['save']))
{
  $Title_No = isset($_POST['Title_No']) ? $_POST['Title_No'] : '';
  $Title_Name = isset($_POST['Title_Name']) ? $_POST['Title_Name'] : '';
  $Title_Description = isset($_POST['Title_Description']) ? $_POST['Title_Description'] : '';
...
if (isset($_POST["update_title"])) {
  ...
  if (empty($error)) {
    $sql = "UPDATE title SET Title_Name='$Title_Name', Title_Description='$Title_Description', Title_Status='$Title_Status' WHERE Title_No='$Title_No'";
